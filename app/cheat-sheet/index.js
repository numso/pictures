...
export default component('CheatSheet', function ({ labels, mode }) {
        ...
        .map((items, key) => {
          return (
            <div className='cheatsheet__section'>
              ...
              {items
                .map(item => {
                  var classes = isCurrent(item)
                    ? 'cheatsheet__group --selected'
                    : 'cheatsheet__group'
                  return (
                    <div className={classes} onClick={setMode(item)}>
                      <div className='cheatsheet__item'>
                        {item.get('label')}
                      </div>
                      <div className='cheatsheet__hotkey'>
                        {item.get('hotkey')}
                      </div>
                    </div>
                  )
